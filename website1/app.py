...
img_Rl = Image.open("/mount/src/we/website1/images/RL.png")
...
lottie_coding3="https://lottie.host/ba76aaaa-a9cb-422d-a234-d4d0cccb2f6b/JgMNz6rJ5t.json"
lottie_coding4="https://lottie.host/cf9e9568-1485-406c-9f66-710934bcb225/FlciKAmZ8Q.json"
lottie_coding5="https://drive.google.com/file/d/1bNALxXx00a-N0WkSAFQI1l_NGF9MaTjT/view?usp=sharing"
...
local_css("/mount/src/we/website1/style/style.css")
...
with st.container():
    ...
    st.subheader("Hi everynoe I'm Abdulrahman Salem Saud :top:")
    ...
    st.write("- Feel free to connect with me on LinkedIn for further engagement: LinkedIn Profile",("[Click Here >](https://www.linkedin.com/in/abdulrahman-saud-915130245/)"))
...
with st.container():
    ...
    with image_column:
        st_lottie(lottie_coding4,height=300,key="")
...
with st.container():
    ...
    with image_column:
        st_lottie(lottie_coding3,height=300,key='str')
...
with st.container():
    ...
    with image_column:
        st_lottie(lottie_coding2,height=300,key='')
